...
const Videos = () => {
    ...
    const deleteItem = (id) => {
        console.log(id)
        var data = ref(database, `Videos/${id}`)
        remove(data)
            .then(() => {
    ...
    const CreateGallery = () => {
        ...
        const handlerSUbmit = async () => {
            ...
            let dbref = ref(database, `Videos`); //ref,path
            ...
            <div className="w-[60%] ml-4 bg-cardColor px-4 py-4 rounded-xl" >
                <div className="w-full  flex flex-col">
                    <div className="flex justify-between py-2 px-2 items-center">
                        <h1 className="text-xl font-bold text-mainTextColor font-[SF-Pro-Display-Regular]">Videos</h1>
                ...
                {selected ? <div className="w-full h-full flex gap-4 ">
                    ...
                    <div className="">
                        <div className="flex mb-6 justify-between my-4 mr-4">
                            <div className="px-4 ">
                                <h1 className={`border-b border-t-0 border-x-0 border-4 border-white inline ${theme == 'light' ? 'text-[#82b012] border-[#82b012]' : 'border-white text-white'} text-5xl font-bold font-[SF-Pro-Display-Regular] tracking-wide`}>Videos</h1>
                            </div>
                            <button onClick={() => (setLoading(true), setSelected(true))} className={`mt-2 uppercase px-4 cursor-pointer ${theme == 'light' ? 'text-white bg-[#82b012]' : 'text-white bg-cardColor'} py-3 rounded font-[SF-Pro-Display-Regular]`}>+ ADD Videos</button>
                        </div>
                        <div>
                            <table>
                                <thead>
                                        ...
                                        return (
                                            <tr>
                                                ...
                                                <td style={{textAlign:"center"}}>
                                                    <video controls src={v.image} style={{height:200,width:500}} alt="" />
                                                </td>
                                                <td>
